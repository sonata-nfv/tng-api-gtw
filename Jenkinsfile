    ...
    stage('Promoting release v5.1') {
      ...
      stages {
        stage('Generating release') {
          steps {
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-api-gtw:latest registry.sonata-nfv.eu:5000/tng-api-gtw:v5.1'
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-api-gtw:latest sonatanfv/tng-api-gtw:v5.1'
            sh 'docker push registry.sonata-nfv.eu:5000/tng-api-gtw:v5.1'
            sh 'docker push sonatanfv/tng-api-gtw:v5.1'
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-sec-gtw:latest registry.sonata-nfv.eu:5000/tng-sec-gtw:v5.1'
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-sec-gtw:latest sonatanfv/tng-sec-gtw:v5.1'
            sh 'docker push registry.sonata-nfv.eu:5000/tng-sec-gtw:v5.1'
            sh 'docker push sonatanfv/tng-sec-gtw:v5.1'
          }
        }
      }
    }
